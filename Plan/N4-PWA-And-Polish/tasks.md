...
- [x] ~~**N4.14 — Recently viewed**~~ → **delivered in [task 12](../12-Home-Dashboard/tasks.md) (12.1–12.3, 12.7).**
  `core.RecentView` + `core.services.recent`, recorded by `RecordsRecentView` on the recipe /
  dish / book detail views, surfaced as the dashboard's "Recently viewed" panel. Nothing left
  to do here.
