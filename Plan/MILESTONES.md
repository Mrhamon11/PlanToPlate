...
| 12 | [Home Dashboard](12-Home-Dashboard/design.md) | NOT STARTED | — | Replaces task 02's placeholder card grid with real content: this week's plan, the active shopping list, recently viewed, favourites, shared-with-you, a dish suggestion, and section counts. **Runs straight after 08**, whose 08.15 carries a reminder to say so. Absorbs `N4.14`. |
