...
| 01 | [Users & Auth](01-Users-And-Auth/design.md) | IN PROGRESS | 2026-08-23 | Subtasks 01.1–01.5 done (last completed: **01.5**, `ForcePasswordChangeMiddleware`); 01.6–01.10 remain. Pipeline converged on iteration 2 — tester PASS, reviewer APPROVE, no blocking findings. Custom User model has landed, so domain models may now reference `AUTH_USER_MODEL`. Resume with `/p2p-task 01`. |
